$('input').keyup(function(){ // run anytime the value changes
    ...
    console.log(eurusdriskinpercentage);


    eurusdriskinpercentage= eurusdriskinpercentage * -1;
    eurusdprofitinpercentage= eurusdprofitinpercentage * -1;
    eurusdstoplosstotal= eurusdstoplosstotal * -1;
    eurusdtakeprofittotal= eurusdtakeprofittotal * -1;
