$('input').keyup(function(){ // run anytime the value changes
    ...
    console.log(gbpusdriskinpercentage);


    gbpusdriskinpercentage= gbpusdriskinpercentage * -1;
    gbpusdprofitinpercentage= gbpusdprofitinpercentage * -1;
    gbpusdstoplosstotal= gbpusdstoplosstotal * -1;
    gbpusdtakeprofittotal= gbpusdtakeprofittotal * -1;
