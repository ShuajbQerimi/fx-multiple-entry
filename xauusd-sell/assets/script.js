$('input').keyup(function(){ // run anytime the value changes
    ...
    console.log(xauusdriskinpercentage);


    xauusdriskinpercentage= xauusdriskinpercentage * -1;
    xauusdprofitinpercentage= xauusdprofitinpercentage * -1;
    xauusdstoplosstotal= xauusdstoplosstotal * -1;
    xauusdtakeprofittotal= xauusdtakeprofittotal * -1;
