$('input').keyup(function(){ // run anytime the value changes
    ...
    console.log(audusdriskinpercentage);


    audusdriskinpercentage= audusdriskinpercentage * -1;
    audusdprofitinpercentage= audusdprofitinpercentage * -1;
    audusdstoplosstotal= audusdstoplosstotal * -1;
    audusdtakeprofittotal= audusdtakeprofittotal * -1;
