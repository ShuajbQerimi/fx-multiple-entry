$('input').keyup(function(){ // run anytime the value changes
    ...
    console.log(gbpjpyriskinpercentage);


    gbpjpyriskinpercentage= gbpjpyriskinpercentage * -1;
    gbpjpyprofitinpercentage= gbpjpyprofitinpercentage * -1;
    gbpjpystoplosstotal= gbpjpystoplosstotal * -1;
    gbpjpytakeprofittotal= gbpjpytakeprofittotal * -1;
